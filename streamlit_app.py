...
st.image('Minutes played.png', caption='Minutes played.png', use_column_width=True)
...
# Display an image from a local file
st.image('elbow method.png', caption='elbow method.png', use_column_width=True)
...
# Display an image from a local file
st.image('K-means clustering.png', caption='K-means clustering.png', use_column_width=True)
